...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10">
      <h1 style="text-align:center">Data FAQ</h3>
        <form class="form-horizontal" method="post" action="<?php echo base_url('WelcomeAdm/insert_faq') ?>" style="margin: 70px 20px 30px 60px;">
