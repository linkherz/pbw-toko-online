...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-10">
      <h1 style="text-align:center">Tas Wanita</h1>
      <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
          <li><a href="<?php echo base_url().'tas_wanita_murah' ?>">Termurah</a></li>
          <li><a href="<?php echo base_url().'tas_wanita_mahal' ?>">Termahal</a></li>
        </ul>
      </div>
